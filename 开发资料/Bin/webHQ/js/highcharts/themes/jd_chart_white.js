...
Highcharts.theme_white = {
	//线的颜色
	colors: ["#0088FF", "blue", "#FDA306", "black", "green", "#ff0066", "#eeaaee",
	...
	xAxis: {
		gridLineWidth: 0,
		lineColor: '#AED8FF', //横坐标轴的颜色
		tickColor: '#AED8FF', //横坐标刻度颜色;
		gridLineColor: '#AED8FF',
		tickWidth:1,//X轴的刻度
		labels: {
			style: {
				color: '#333333',  //横坐标文字标签颜色
				fontWeight: 'bold'
			}
		},
		title: {
	...
	yAxis: {
		...
		gridLineColor: '#AED8FF',  //y轴对应的网格线颜色
		lineColor:"#AED8FF",
		minorGridLineColor: '#AED8FF',
		lineWidth: 1, //是否显示Y轴的 轴线
		tickWidth: 0, //Y轴的刻度
		labels: {
			style: {
				color: '#333333'  //纵坐标文字标签颜色
			}
		},
		title: {
			style: {
